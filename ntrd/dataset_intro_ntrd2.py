...
class dataset(object):
    ...
    def padding_context(self,contexts,pad=0,transformer=True):
        ...
        if transformer==False:
            ...
            vec,v_l,concept_mask,dbpedia_mask,reviews_mask, introduction_mask,movies_gth = self.padding_w2v(contexts_com,self.max_c_length,transformer)
    ...
    def data_process(self,is_finetune=False):
        ...
        for line in self.data:
            ...
            if False:
                ...
                mask_response, mask_r_length, _, _, _, _, _ = self.padding_w2v(
