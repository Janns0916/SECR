from comet.src.data import config as cfg
from comet.src.data import data as data
from comet.src.interactive import functions as interactive
from comet.src.models import utils as model_utils
import numpy as np
import torch
...
class CSKFeatureExtractor():
    ...
    def __init__(self):
        ...
        data_loader, text_encoder = interactive.load_data(path, opt)
