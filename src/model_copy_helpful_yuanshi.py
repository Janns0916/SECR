...
class CrossModel(nn.Module):
    ...
    def forward(self, xs, ys, mask_ys, concept_mask, db_mask, reviews_mask, introduction_mask, seed_sets,
        ...
        return scores, preds, entity_scores, rec_loss, gen_loss, mask_loss, info_db_loss, info_con_loss, info_genre_loss, genre_emb_count, info_attr_loss, attr_emb_count
    ...
    # def save_model(self, model_name=r'E:\janns\MACR-master3\saved_model\net_parameter1.pkl'):
    def save_model(self):
